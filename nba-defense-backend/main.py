...
def clean_player(row):
    return {
        ...
        "rim_protection_percentile": round(row['rim_protection_percentile'], 0),
        "rim_protection_label": row['rim_protection_label'],
        "shot_contesting_score": round(row['shot_contesting_score'], 1),
        "shot_contesting_percentile": round(row['shot_contesting_percentile'], 0),
        "shot_contesting_label": row['shot_contesting_label'],
        "ball_disruption_score": round(row['ball_disruption_score'], 1),
        "ball_disruption_percentile": round(row['ball_disruption_percentile'], 0),
        "ball_disruption_label": row['ball_disruption_label'],
        "on_ball_matchup_def_score": round(row['on_ball_matchup_def_score'], 1),
        "on_ball_matchup_def_percentile": round(row['on_ball_matchup_def_percentile'], 0),
        "on_ball_matchup_def_label": row['on_ball_matchup_def_label'],
        "def_reb_score": round(row['def_reb_score'], 1),
        "def_reb_percentile": round(row['def_reb_percentile'], 0),
        "def_reb_label": row['def_reb_label'],
